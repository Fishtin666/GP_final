...
//
//
//public class CollectionTest extends AppCompatActivity {
...
//                    Intent intent = new Intent(CollectionTest.this, R_topic.class);
...
//                            } else {
//                                Toast.makeText(CollectionTest.this, "Failed to fetch data", Toast.LENGTH_SHORT).show();
//                            }
//                        } catch (Exception e) {
//                            e.printStackTrace();
//                            Log.e("Level_A4567", "getQuestionAndOptions error" + e.getMessage());
//                        }
//                    }
//                });
//    }
...
////        SharedPreferences sharedPreferences = getSharedPreferences("Score", MODE_PRIVATE);
////        String GetWord = sharedPreferences.getString("word", 0);
////
////        if (GetWord == "Login"){
////            GetScore(score);
////            ShowScoreDialog();
