...
public class Chos2 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        SharedPreferences sharedPreferences = getSharedPreferences("R_number", MODE_PRIVATE);
        int R_Log = sharedPreferences.getInt("R_number", 0);

        ImageButton backButton = findViewById(R.id.back);
        backButton.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent intent = new Intent(Chos2.this, R_topic.class);
        ...
        adapter = new ChosReadingAdapter(this, ChoseTestNum(questionList, R_Log));
        ...
        collection.document(String.valueOf(R_number)).collection("Questions")
                ...
                .addOnSuccessListener(queryDocumentSnapshots -> {
                    if (!queryDocumentSnapshots.isEmpty()) {
                        ...
                        Toast.makeText(Chos2.this, "No questions found", Toast.LENGTH_SHORT).show();
                    }
                })
