...
public class LevelAQuizActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        new Handler().postDelayed(() -> wordSendButton.setVisibility(View.VISIBLE), 2000);
...
//                        GoToMain(Level);
                        if (Score < 6) {
                            ...
                            Intent intentA = new Intent(LevelAQuizActivity.this, LevelAQuizActivity.class);
...
//                            userRef.child("WordLevel").setValue("A");
//                        } else {
//                            userRef.child("WordLevel").setValue("NoLevel");
//                        }
//
//                    } else {
//                        userRef.child("WordLevel").setValue(WordLevel);
        ...
        userRef.addListenerForSingleValueEvent(new ValueEventListener() {
            ...
            public void onDataChange(@NonNull DataSnapshot snapshot) {
                if (snapshot.exists()) {
                    ...
                    String currentLevel = snapshot.child("WordLevel").getValue(String.class);
                    if (currentLevel != null) {
                        if (score > 5 && !"B".equals(currentLevel) && !"C".equals(currentLevel)) {
                            userRef.child("WordLevel").setValue("A");
                            Log.e("level AAAA", "pass save" + score + WordLevel + currentLevel);
                        } else {
                            Log.e("level AAAA", "pass failed save" + score + WordLevel);
