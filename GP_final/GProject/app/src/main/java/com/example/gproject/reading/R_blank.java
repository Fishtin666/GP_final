...
public class R_blank extends AppCompatActivity {
    ...
    int numberOfFields = 6;  // Set the Number of Question
...
//                view.setVisibility(View.GONE);
                        ...
                        if (task.isSuccessful()) {
                            ...
                            try {
                                if (document.exists()) {
                                    ...
                                    //replace textview
                                    articleContentTextView = findViewById(R.id.Content);
                                    Q1TextView = findViewById(R.id.Q1);

                                    if (articleContentTextView != null && Q1TextView != null) {
                                        CharSequence conText = articleContentTextView.getText();
                                        CharSequence Q1text = Q1TextView.getText();

                                        Log.e("blank0", "successful getting content: " + conText);
                                        Log.e("blank0", "successful getting Q1 text: " + Q1text);

                                        replaceTextview(articleContentTextView, conText);
                                    ...
                                    for (int i = 0; i < numberOfFields; i++) {
                                        ...
                                        if (document.contains(ansName)) {
                                            ...
                                            Log.e("blank0", "size Of ：" + incorrectAnswers.size());
                                            Log.e("blank0", "no " + ansName);
                                            break;
                                        }
                                    }
    ...
    private void showReminderDialog() {
        ...
        builder.setMessage("輸入答案時，請注意大小寫，需依題目要求填寫，並且不要有任何空格。");
