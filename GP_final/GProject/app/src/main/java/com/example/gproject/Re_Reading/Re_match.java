...
public class Re_match extends AppCompatActivity {
...
//                startActivity(intent);
        ...
        home.setOnClickListener(new View.OnClickListener(){
            @Override
            public void onClick(View v) {
                Intent intent = new Intent(Re_match.this, MainActivity.class);
                startActivity(intent);
                finish();
            }
        });
                                ...
                                public void onComplete(@NonNull Task<DocumentSnapshot> task) {
                                    if (task.isSuccessful()) {
                                        ...
                                        if (firestoreDocument != null && firestoreDocument.exists()) {
                                            ...
                                            TextView matTextView = findViewById(R.id.match);

                                            if (ContentTextView != null) {
                                                CharSequence conText = ContentTextView.getText();
                                                CharSequence matText = matTextView.getText();
                                                replaceTextview(ContentTextView, conText);
                                                replaceTextview2(matTextView,matText);
